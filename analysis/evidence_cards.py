...
DIMENSION_CONFIG: dict[str, dict] = {
    ...
    # ---- Extended dimensions (24 added) ----
    "care_access": {
        "metric": "health_vulnerability_composite",
        "ascending": False,
        "data_quality": "moderate",
        "quality_note": "ACS uninsured rate + CDC no-healthcare-access as care access proxy",
    },
    "care_quality": {
        "metric": "cdc_physical_health_composite",
        "ascending": False,
        "data_quality": "moderate",
        "quality_note": "CDC PLACES obesity + diabetes + physical health burden as care quality proxy",
    },
    "care_workforce": {
        "metric": "poverty_rate",
        "ascending": False,
        "data_quality": "moderate",
        "quality_note": "poverty rate as care workforce shortage proxy (low-income areas have highest vacancy rates)",
    },
    "civil_rights": {
        "metric": "race_poverty_interaction",
        "ascending": False,
        "data_quality": "moderate",
        "quality_note": "pct_non_hispanic_black × poverty_rate as racial disparity measure",
    },
    "climate_equity": {
        "metric": "poverty_rate",
        "ascending": False,
        "data_quality": "moderate",
        "quality_note": "poverty rate as climate vulnerability proxy (low-income communities bear disproportionate climate burden)",
    },
    "community_safety": {
        "metric": "race_poverty_interaction",
        "ascending": False,
        "data_quality": "moderate",
        "quality_note": "pct_non_hispanic_black × poverty_rate as community safety disparity proxy",
    },
    "economic_opportunity": {
        "metric": "median_hh_income_inverse",
        "ascending": False,
        "data_quality": "strong",
        "quality_note": "median household income (inverse) — lower income = less economic opportunity",
    },
    "education_access": {
        "metric": "poverty_rate",
        "ascending": False,
        "data_quality": "moderate",
        "quality_note": "poverty rate as education access proxy (low-income areas have reduced higher education access)",
    },
    "environmental_governance": {
        "metric": "pct_poc",
        "ascending": False,
        "data_quality": "moderate",
        "quality_note": "pct_poc as proxy for communities most harmed by weak environmental governance",
    },
    "environmental_justice": {
        "metric": "race_poverty_interaction",
        "ascending": False,
        "data_quality": "moderate",
        "quality_note": "pct_non_hispanic_black × poverty_rate as environmental justice intersection proxy",
    },
    "fiscal_autonomy": {
        "metric": "median_hh_income_inverse",
        "ascending": False,
        "data_quality": "moderate",
        "quality_note": "median household income (inverse) — lower-income communities have least fiscal autonomy under state levy limits",
    },
    "fiscal_equity": {
        "metric": "poverty_burden_composite",
        "ascending": False,
        "data_quality": "moderate",
        "quality_note": "poverty_rate + pct_cost_burdened composite as fiscal inequity measure",
    },
    "health_equity": {
        "metric": "health_vulnerability_composite",
        "ascending": False,
        "data_quality": "strong",
        "quality_note": "ACS uninsured rate + CDC no-healthcare-access as health equity gap measure",
    },
    "housing_supply": {
        "metric": "pct_cost_burdened",
        "ascending": False,
        "data_quality": "strong",
        "quality_note": "housing cost burden as supply shortage indicator (cost burden rises when supply is constrained)",
    },
    "housing_transit": {
        "metric": "poverty_rate",
        "ascending": False,
        "data_quality": "moderate",
        "quality_note": "poverty rate as transit-housing nexus proxy (low-income residents most dependent on transit-oriented housing)",
    },
    "immigration_rights": {
        "metric": "pct_poc",
        "ascending": False,
        "data_quality": "moderate",
        "quality_note": "pct_poc as proxy for immigrant community concentration",
    },
    "labor_mobility": {
        "metric": "median_hh_income_inverse",
        "ascending": False,
        "data_quality": "moderate",
        "quality_note": "median household income (inverse) — lower income correlates with reduced labor mobility and wage suppression",
    },
    "land_preservation": {
        "metric": "poverty_rate",
        "ascending": False,
        "data_quality": "moderate",
        "quality_note": "poverty rate as rural land access proxy (development pressure displaces low-income rural communities)",
    },
    "legal_equity": {
        "metric": "race_poverty_interaction",
        "ascending": False,
        "data_quality": "moderate",
        "quality_note": "pct_non_hispanic_black × poverty_rate as legal system disparity proxy",
    },
    "public_safety": {
        "metric": "race_poverty_interaction",
        "ascending": False,
        "data_quality": "moderate",
        "quality_note": "pct_non_hispanic_black × poverty_rate as public safety disparity proxy",
    },
    "reproductive_rights": {
        "metric": "health_vulnerability_composite",
        "ascending": False,
        "data_quality": "moderate",
        "quality_note": "ACS uninsured rate + CDC no-healthcare-access as reproductive healthcare access proxy",
    },
    "rural_equity": {
        "metric": "median_hh_income_inverse",
        "ascending": False,
        "data_quality": "moderate",
        "quality_note": "median household income (inverse) — rural counties have lower median incomes and face greater equity gaps",
    },
    "transit_safety": {
        "metric": "poverty_rate",
        "ascending": False,
        "data_quality": "moderate",
        "quality_note": "poverty rate as transit safety proxy (safety deficits concentrate in low-income transit-dependent communities)",
    },
    "tribal_sovereignty": {
        "metric": "pct_poc",
        "ascending": False,
        "data_quality": "moderate",
        "quality_note": "pct_poc as proxy for tribal community concentration (tribal nations are POC communities in WI data)",
    },
}
